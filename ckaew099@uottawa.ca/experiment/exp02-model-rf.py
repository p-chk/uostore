...
param_grid = {
        ...
        'classifier__n_estimators': [40, 50, 60, 200],
        'classifier__max_features': ['auto', 'sqrt', 'log2'],
        'classifier__class_weight': ['balanced']
}
cv = StratifiedKFold(n_splits=10)
grid_search = GridSearchCV(estimator=random_forest_pipeline, param_grid=param_grid, cv=cv, scoring='accuracy', n_jobs=-1)
...
with mlflow.start_run(run_name="exp-02-random-forest"):
